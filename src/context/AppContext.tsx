...
import { createGrievance as createGrievanceService, addConfirmation as addConfirmationService, updateGrievanceStatus as updateGrievanceStatusService, verifyResolution as verifyResolutionService, getGrievances, getClusters } from '../services/grievanceService';
  ...
  const loadRealData = useCallback(async () => {
    ...
    try {
      ...
      if (isSupabaseConfigured) {
        ...
        // Supabase not configured — use seeded local data for live app state
